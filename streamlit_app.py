...
Modulul 1: Țările și Capitalele Lumii:

python
        # --- GEOGRAFIE: ȚĂRI ȘI CAPITALE ---
        ...
        "egipt": "Țară în Africa de Nord. Capitala: Cairo.",
...
Modulul 2: Elementele Chimice (principalele):

python
        # --- CHIMIE: ELEMENTE CHIMICE ---
...
Modulul 3: Slujbe și Profesii din Lume:
...
Modulul 4: Criptomonede și Educație Financiară:

python
        # --- CRIPTOMONEDE & EDUCAȚIE FINANCIARĂ ---
